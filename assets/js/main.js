...
console.log(defUpperStr('text')); // TEXT
...
console.log(evenFn(12)); // [2, 4, 6, 8, 10, 12]
console.log(evenFn(17)); // [2, 4, 6, 8, 10, 12, 14, 16]
...
console.log('-100 :', ageClassification(-1)); 
console.log('   0 :', ageClassification(0)); 
console.log('   1 :', ageClassification(1)); 
console.log('   40:', ageClassification(40));
console.log('   40.01:', ageClassification(40.01));
...
console.log('   200:', ageClassification(200));
/*
